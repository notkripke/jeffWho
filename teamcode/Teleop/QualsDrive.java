...
@TeleOp(group = "AAAAAAAAAA", name = "QualsDrive")
public class QualsDrive extends GorillabotsCentral {
           ...
           if(gamepad2.dpad_down){
            ...
            if(gamepad1.right_bumper){
               grabber.setPosition(Grabber_Close);
                telemetry.addData("Grabber","closed");
            }
            ...
            switch(shootToggle){
                case 0:
                    ...
                    break;
                case 1:
                    ShooterMotor.setPower(0.735); //.84
